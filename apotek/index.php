...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <?php require("view/navbar/navitem3.php") ?>
      ...
      <?php
      require("view/navbar/navitem4.php");
      require("view/navbar/navitem5.php");
      require("view/navbar/navitem6.php");
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="view/editapotik.php?email=<?php echo $_SESSION['user']['email'] ?>">
