...
<head>
  ...
  <title>Profil - TOBAT Online</title>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group input-group">
                    ...
                    <input name="sia" class="form-control" placeholder="Surat Izin Apotik" type="text" value="<?php echo $data['sia'] ?>" required>
                  </div> <!-- form-group end.// -->
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
