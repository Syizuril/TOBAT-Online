...
(20, 'BETADINE SABUN CAIR 60ML', 'Betadine sabun cair antiseptik yang digunakan untuk mengatasi masalah pada kulit seperti jerawat, gatal-gatal dan untuk menjaga kesehatan kulit.', '00000697_BetadineSabunCair60ML-400x400.jpg', 'Antiseptik dan Desinfektan Kulit', 'Povidon iodine 7,5%', 'Untuk mandi, untuk mengobati jerawat dan gatal-gatal di kulit,Membersihkan kulit dan tangan sebelum melakukan operasi, membersihkan kulit yang akan di operasi', 'Sesuai kebutuhan', 'Gunakan Betadine sabun cair antiseptik seperti anda menggunakan sabun mandi biasa', '-', 'Hanya untuk pemakaian luar', 'Reaksi hipersensitif terhadap iodium', '1', 'Mahakam Beta Farma', 'Terakhir diperbarui pada 30 April 2019', 'Referensi BETADINE SABUN CAIR 60ML diambil dari berbagai macam sumber.', 26892);
