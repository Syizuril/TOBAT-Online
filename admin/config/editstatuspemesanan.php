<?php
  ...
  if(isset($_POST['proses']))
      try{
      //menyiapkan query
      $sql = "UPDATE transaksi SET id_apotek=:id_apotek,status_beli=:status_beli, status_bayar=:status_bayar WHERE id_apotek=:id_apotek,nomor_transaksi=:nomor_transaksi ";
      $stmt = $db->prepare($sql);
