...
<head>
  ...
  <title>Tambah Apotek - TOBAT Online</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
            ...
            <?php
              require("../config/registerapotik.php");
             ?>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Data Apotik</h6>
                </div>
                <div class="card-body">
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                  ...
                  <div class="form-group input-group">
                    ...
                    <input name="sia" class="form-control" placeholder="Surat Izin Apotik" type="text" required>
                  </div> <!-- form-group end.// -->
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
